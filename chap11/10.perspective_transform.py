...
image = cv2.imread("C:/Users/we726/PycharmProjects/pythonProject/source/images/perspective.jpg", cv2.IMREAD_COLOR)
if image is None: raise Exception("영상파일 읽기 에러")

pts1 = np.float32([(80, 40), (315, 133), (75, 300), (355, 300)])    #입력 영상 4개 좌표
...
#pts3 = np.squeeze(pts3, axis=0)    #차원 감소 - 결과 표시 위해
