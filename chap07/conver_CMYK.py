...
BGR_img = cv2.imread("C:/Users/we726/PycharmProjects/pythonProject/source/images/color_model.jpg", cv2.IMREAD_COLOR) #컬러 영상 읽기
...
[cv2.imshow(t, eval(t))for t in titles] #리스트 생성 방식 활용
cv2.waitKey(0)