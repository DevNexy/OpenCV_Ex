...
def print_matInfo(name, image): #행렬 정보 출력 함수
    ...
    elif image.dtype == 'unit16': mat_type = 'CV_16U'
...
gray2gray = cv2.imread("C:/Users/we726/PycharmProjects/pythonProject/source/images/read_gray.jpg", cv2.IMREAD_GRAYSCALE) # 명암도
gray2color = cv2.imread("C:/Users/we726/PycharmProjects/pythonProject/source/images/read_gray.jpg", cv2.IMREAD_COLOR) # 컬러 영상
...
cv2.imshow(title1, gray2gray) #행렬 정보
